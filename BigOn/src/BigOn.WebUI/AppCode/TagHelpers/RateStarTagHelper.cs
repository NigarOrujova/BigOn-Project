...
namespace BigOn.WebUI.AppCode.TagHelpers
{
    ...
    public class RateStarTagHelper : TagHelper
    {
        ...
        [HtmlAttributeName("rate-entity-id")]
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.Content.SetHtmlContent(@$"<li data-rate='1' data-entity-id='{this.EntityId}'></li>
        <li data-rate='2' data-entity-id='{this.EntityId}'></li>
        <li data-rate='3' data-entity-id='{this.EntityId}'></li>
        <li data-rate='4' data-entity-id='{this.EntityId}'></li>
        <li data-rate='5' data-entity-id='{this.EntityId}'></li>");
        }
    }
}
